            ...
            {consultations?.length !== 0 ? (
                            ...
                            <tbody>
                                {consultations?.map((item, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className={
                                                item.status === "waiting" ? "text-success"
                                                : item.status === "pending" ? "text-warning"
                                                : "text-danger"
                                            } >
                                            {item.status === "waiting" ? "Waiting Live Consultation"
                                                : item.status === "pending" ? "Waiting Approved Consultation Live"
                                                : "Cancel"}
                                        </td>
                                        <td>
                ...
                <div>
                    ...
                    <div className="text-center">
                        <img className="img-fluid" style={{ width: "30%" }} alt="" src={noData} />
